    ...
    <div class="sm:hidden">
        ...
        >
            @foreach($pages as $pageName => $page)
                ...
                @endif
            @endforeach
            @if(Auth::check() && $user->memberships->count() > 0)
                ...
                @if(Auth::check() && $pageName === 'userGroups')
                    ...
                    @else
                        <a
                            ...
                            class="inline-flex items-center justify-center h-9 rounded-full px-5 text-sm leading-none transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-600 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-100 text-zinc-600 font-medium hover:bg-white/70 hover:text-zinc-900"
                        >Create Group</a>
                    @endif
